...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("TasksObjectPageObjectPage journey");

        opaTest("Navigate to TasksObjectPageObjectPage", function (Given, When, Then) {
            Given.iStartMyApp();
            ...
            Then.onTheEmployeesObjectPage.onTable({ property: "assignedTasks" }).iCheckRows();
            When.onTheEmployeesObjectPage.onTable({ property: "assignedTasks" }).iPressRow(0);
