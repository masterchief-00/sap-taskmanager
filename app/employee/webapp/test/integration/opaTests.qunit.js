...
sap.ui.require(
  [
    ...
    "ns/employee/test/integration/EmployeesListJourney",
    "ns/employee/test/integration/EmployeesObjectPageJourney",
    "ns/employee/test/integration/TasksObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
